...
def test_column_numeric():
    ...
    assert protocol.build_numeric(Decimal(1234) / Decimal(100)) == \
        b'\x00\x00\x00\x0c\x00\x02\x00\x00\x00\x00\x00\x02\x00\x0c\rH'
    assert protocol.build_numeric(Decimal(-1234) / Decimal(100)) == \
    ...
    assert protocol.build_numeric(Decimal('5.7288')) == \
        b'\x00\x00\x00\x0c\x00\x02\x00\x00\x00\x00\x00\x04\x00\x05\x1cx'
    assert protocol.build_numeric(Decimal('2.2622600000000003164')) == \
        b'\x00\x00\x00\x14\x00\x06\x00\x00\x00\x00\x00\x13\x00\x02\n>\x17p\x00\x00\x00\x03\x06h'
    assert protocol.build_numeric(Decimal('5.69483')) == \
        b'\x00\x00\x00\x0e\x00\x03\x00\x00\x00\x00\x00\x05\x00\x05\x1b$\x0b\xb8'
    assert protocol.build_numeric(Decimal('152.080')) == \
        b'\x00\x00\x00\x0c\x00\x02\x00\x00\x00\x00\x00\x03\x00\x98\x03 '
    assert protocol.build_numeric(Decimal('44.80428')) == \
        b'\x00\x00\x00\x0e\x00\x03\x00\x00\x00\x00\x00\x05\x00,\x1fj\x1f@'
    ...
    assert protocol.build_numeric(Decimal('6.4965')) == \
        b'\x00\x00\x00\x0c\x00\x02\x00\x00\x00\x00\x00\x04\x00\x06\x13e'
    assert protocol.build_numeric(Decimal('71.78358')) == \
        b'\x00\x00\x00\x0e\x00\x03\x00\x00\x00\x00\x00\x05\x00G\x1e\x9b\x1f@'
    ...
    assert protocol.build_numeric(Decimal('38.69635')) == \
        b'\x00\x00\x00\x0e\x00\x03\x00\x00\x00\x00\x00\x05\x00&\x1b3\x13\x88'
    assert protocol.build_numeric(Decimal('5.7288')) == \
        b'\x00\x00\x00\x0c\x00\x02\x00\x00\x00\x00\x00\x04\x00\x05\x1cx'
    assert protocol.build_numeric(Decimal('2.2622600000000003164')) == \
        b'\x00\x00\x00\x14\x00\x06\x00\x00\x00\x00\x00\x13\x00\x02\n>\x17p\x00\x00\x00\x03\x06h'
